 ...
 */
async function sendReadyForPickupEmail(to, pickupInstructions, orderDetails) {
  const resend = getResend();
  ...
  <div style="max-width: 560px; margin: 0 auto; padding: 40px 20px;">
    <div style="background: white; border-radius: 16px; padding: 40px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);">
      <div style="text-align: center; margin-bottom: 32px;">
        ...
        <h1 style="color: #059669; margin: 0; font-size: 24px;">Your Order is Ready for Pickup!</h1>
      </div>
      
      <p style="margin: 0 0 16px;">Hi there,</p>
      
      <p style="margin: 0 0 24px;">Great news! Your passport photos have been processed and are ready for pickup.</p>
      
      <div style="background: #f0fdf4; border-left: 4px solid #059669; padding: 20px; border-radius: 0 12px 12px 0; margin: 24px 0;">
        <h3 style="color: #059669; margin: 0 0 12px; font-size: 16px;">📍 Pickup Instructions</h3>
        <p style="margin: 0; color: #166534; white-space: pre-wrap;">${pickupInstructions || 'Please contact us for pickup details.'}</p>
      </div>
      ...
      <div style="background: #f8fafc; padding: 16px; border-radius: 8px; margin: 24px 0;">
        ...
        <p style="margin: 0; color: #64748b; font-size: 14px;">Country: ${orderDetails.country || '-'}</p>
      </div>
      ` : ''}
      ...
      <p style="margin: 0; color: #64748b; font-size: 14px; text-align: center;">
        Questions? Reach out to us on WhatsApp: <a href="https://wa.me/15513587475" style="color: #4f46e5;">551-358-7475</a>
      </p>
    </div>
  </div>
</body>
